    ...
    render() {
        return(
            <div>
                ...
                <br></br>
                <input name='includes' value={this.state.includes} type='text' className='inputIncludes' id='inputIncludes'></input>
                <button onClick={this.includesFunction} className='buttonIncludes' id='buttonIncludes'>Search</button>
                <br></br>
                <span className='spanIncludesResult' id='spanIncludesResult'></span>
